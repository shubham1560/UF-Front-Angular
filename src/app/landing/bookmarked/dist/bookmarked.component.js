...
var BookmarkedComponent = /** @class */ (function () {
    function BookmarkedComponent(loggerService, userService) {
        this.loggerService = loggerService;
        this.userService = userService;
    }
    BookmarkedComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userService.getBookmarkedArticles(0, 3).subscribe(function (result) {
            _this.bookmarkedArticles = result;
        });
        this.loggerService.logData("uf-bookmarked", this);
    };
    BookmarkedComponent = __decorate([
        core_1.Component({
